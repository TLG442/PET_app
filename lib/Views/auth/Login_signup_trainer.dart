...
import 'package:petapp/utils/app_color.dart';
import 'package:petapp/widgets/my_widgets.dart';

import '../../controller/auth_controller.dart';


class LoginViewTrainer extends StatefulWidget {
  LoginViewTrainer({Key? key}) : super(key: key);

  @override
  State<LoginViewTrainer> createState() => _LoginViewState();
}

class _LoginViewState extends State<LoginViewTrainer> {
            ...
            child: Column(
              children: [
                ...
                isSignUp
                  ...
                  child: myText(
                    text:
                    'Welcome,Training a dog is not about dominance',
                  ...
                  child: myText(
                    text:
                    'Welcome back, Training a dog is not about dominance',
                    style: GoogleFonts.roboto(
                      letterSpacing: 0,
                      fontSize: 18,
                      fontWeight: FontWeight.w400,
            ...
            Obx(()=> authController.isLoading.value? Center(child: CircularProgressIndicator(),) : Container(
              ...
              child: elevatedButton(
                ...
                onpress: () {
                  ...
                  authController.signUpTrainer(email: emailController.text.trim(),password: passwordController.text.trim());
