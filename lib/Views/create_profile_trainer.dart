...
class ProfileScreenTrainer extends StatefulWidget {
  @override
  _ProfileScreenState createState() => _ProfileScreenState();
}

class _ProfileScreenState extends State<ProfileScreenTrainer> {
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                textField(
                    text: 'Cost amount per session',
                    controller:CostController,
                    validator: (String input) {
                      if (CostController.text.isEmpty) {
                        Get.snackbar('Warning', 'Cost is required.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                textField(
                    ...
                    validator: (String input) {
                      if (CertificateController.text.isEmpty) {
                        Get.snackbar('Warning', 'Certificate is required.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                Obx(()=> authController!.isProfileInformationLoading.value? Center(child: CircularProgressIndicator(),) :Container(
                  ...
                  child: elevatedButton(
                    ...
                    onpress: () async{
                      ...
                      authController!.uploadProfileDataTrainer(imageUrl, firstNameController.text.trim(), lastNameController.text.trim(),CostController.text.trim(),CertificateController.text.trim(), mobileNumberController.text.trim(), dob.text.trim(), selectedRadio ==0 ? "Male": "Female");
